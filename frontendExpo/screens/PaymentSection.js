...
const PaymentSection = () => {
    return (
        <View style={styles.paymentSection}>
            ...
            <View
                style={[styles.paymentSectionItem, styles.paymentShadowBox]}
            />
            <View
                style={[styles.paymentSectionInner, styles.paymentShadowBox]}
            />
            ...
            />
            <Text style={[styles.pm900, styles.pm900Typo]}>
                8:00 pm - 9:00 pm
            </Text>
            <Text style={[styles.bookingDate, styles.bookingTypo]}>
                Booking Date
            </Text>
            <Image
            ...
            <Text style={[styles.cashOnSite, styles.qrTypo]}>
                Cash (On site)
            </Text>
            <Image
            ...
            <Text style={[styles.totalCart, styles.totalCartPosition]}>
                Subtotal
            </Text>
            ...
            <Text style={[styles.upTo24, styles.upTo24Layout]}>
                Up to 24 Hours
            </Text>
        </View>
    );
