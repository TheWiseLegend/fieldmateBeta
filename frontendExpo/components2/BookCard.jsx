                ...
                <View style={[styles.frame2, styles.frameFlexBox]}>
                    <View style={styles.date}>
                        ...
                        <View style={[styles.date2, styles.date2Layout]}>
                            <View
                                style={[styles.background, styles.date2Layout]}
                            />
                            <Text
                                style={[
                                    styles.monday09December,
                                    styles.date1Typo
                                ]}
                            >
            ...
            <View style={styless.frame}>
                <View style={styless.date}>
                    ...
                    <View style={[styless.date1, styless.dateLayout]}>
                        ...
                        />
                        <Text style={[styless.min, styless.minTypo]}>
                            60 min
                        </Text>
                    </View>
                </View>
                <View style={[styless.date2, styless.dateLayout]}>
                    <View
                        style={[styless.background, styless.backgroundLayout]}
                    />
